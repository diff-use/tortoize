...
constexpr const char kProjectName[] = "tortoize";
constexpr const char kVersionNumber[] = "2.0.16";
constexpr int kBuildNumber = 151;
constexpr const char kRevisionGitTag[] = "e596713*";
constexpr const char kRevisionDate[] = "2026-01-27T17:32:24Z";
